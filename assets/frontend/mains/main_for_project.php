<section class="section_1" style="width: 100%; display: grid; gap: 100px;">
	<div style="display: grid; width: 75%; align-items: start; justify-self: center;"> <!-- padding-top: 10%; -->
		{query_header_page}
...
<script>
	$(document).ready(function() {
		...
		name.size = name.value.length - 12;
	})
</script>