...
function addContacts() {
    ...
    span.innerHTML = ' <input class="head_content shower_hider" type="text" value="Телефон" readOnly hidden> \
						...
						<input class="contact contentProperty" id="phone" name="phone" type="tel" oninput="mask_phone();" maxlength="17" value="+7(___)___-__-__" placeholder="+7(___)___-__-__" readOnly/> \
