...
function psql_query_projects($params, $smarty){
    ...
    if ($status) {
        ...
        foreach ($array_data as $data) {
            ...
            $html .= '
            <form class="formProject" method="POST" action="/assets/frontend/pages/project.php">
                ...
                <div class="div-right" > <!-- background-color: green; -->
    ...
    if ($status) {
        ...
        for ($i = 0; $i < $count; $i++) {
           ...
           /*$html.=
            ...
            $html .= '<input hidden type="submit" name="id" id="id" value="'.$data["id"].'">';
        ...
        foreach ($array_data as $data) {
            switch ($params["for"]) {
                ...
                case 'about':
                    ...
                    $html .= '<textarea class="contentProperty" id="about" style="width: 100%;" readonly>'.$data['about'].'</textarea>';
                    break;
                case 'head':
                    $html .= '
...
function psql_query_properties_project($params, $smarty){
    ...
    switch($params["for"]){
        case 'properties':
            ...
            <span>
                <label for="select_status">Статус:  <input class="contentProperty" id="status"            value="'.$status.'"         name="selectStatus" readonly /></label> <!-- hidden type="hidden" -->
