...
function content_67d19acd1608a0_26171523 (\Smarty\Template $_smarty_tpl) {
...
<section id="sctn-3" data-aos="fade-up">
	<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('query_article')->handle(array('head1'=>"А это основные",'svg'=>"1",'head3'=>"исследований и разработки",'class'=>"HelveticaMainWhite",'style'=>"display: grid; width: 80%;"), $_smarty_tpl);?>
...
<section id="sctn-4" data-aos="fade-up">
	<div style="width: 100%;height: fit-content;/* justify-content: flex-end; */display: flex;flex-direction: column;align-items: center;"> 
		...
		<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('query_article')->handle(array('head1'=>"Лучший",'head2'=>"дизайнер",'head3'=>"месяца",'id'=>"article-item",'class'=>"VasekMain2",'class2'=>"VasekMain",'style'=>"width: 25%; display: grid;"), $_smarty_tpl);?>
